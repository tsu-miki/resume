...
## 職務要約
2021年4月にアライドアーキテクツ株式会社へ新卒入社。UGC活用マーケティングSaaS「Letro」の開発にて、新規・保守開発を経験（約3年）。

2024年3月より株式会社ユーザベースへ入社。XP(エクストリームプログラミング)をベースとした開発体制のもと、経済情報プラットフォーム「Speeda」の保守開発および「Speeda AI Agent」モバイル版・デスクトップ版（Web）の新規開発に従事し、現在に至る。
